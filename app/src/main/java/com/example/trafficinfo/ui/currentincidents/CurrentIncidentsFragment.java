//Reza Merati S1711794
package com.example.trafficinfo.ui.currentincidents;
...
public class CurrentIncidentsFragment extends Fragment {
    ...
    String BASE_URL = "https://trafficscotland.org/rss/feeds/currentincidents.aspx",
            responseTxt ="", titleTxt = "", descriptionTxt = "", pubDateTxt = "", linkTxt = "", latLongTxt = "";

    ArrayList<TrafficInfoModel> accidentList;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        recyclerView=view.findViewById(R.id.currentIncidentRecyclerView);
        progressBar=view.findViewById(R.id.currentIncidentProgressBar);
    ...
    private void setValuesOnAdapter() {
        getActivity().runOnUiThread(new Runnable() {
            @Override
            public void run() {
                adapter = new TrafficAdapter(accidentList,getActivity());
        ...
        try {
            ...
            while (eventType != XmlPullParser.END_DOCUMENT) {
                ...
                if(eventType == XmlPullParser.START_DOCUMENT) {
                    ...
                    if(tagName.equalsIgnoreCase("item")) {
                        foundItem = false;
                        accidentList.add(new TrafficInfoModel(titleTxt,descriptionTxt,pubDateTxt,latLongTxt,linkTxt));
